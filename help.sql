...
#
# Structure for table "role_auth_copy"
#

DROP TABLE IF EXISTS `role_auth_copy`;
CREATE TABLE `role_auth_copy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL DEFAULT '0',
  `auth_id` int(11) NOT NULL DEFAULT '0',
  `is_delete` int(1) NOT NULL DEFAULT '0',
...
#
# Structure for table "roles_copy"
#
...
#
# Data for table "roles_copy"
#

INSERT INTO `roles_copy` VALUES (1,'管理员','2','2019-01-29 14:31:57',0,0,1),(2,'代理','12','2019-01-29 14:33:02',0,0,2),(3,'微信用户','1','2019-01-29 15:21:20',0,0,3);
